...
Up to three unseen alerts, each with a severity pill, the title, the message, the detector name and a **Mark seen** button, plus a link to all alerts. When nothing is unseen it shows a green **ALL CLEAR** pill and either the last alert's date and title or "no alerts recorded yet". See [Alerts](/argus/docs/alerts/).
