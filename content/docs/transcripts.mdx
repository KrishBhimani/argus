...
Full-text search over everything you typed and everything Claude wrote. At `/search`, under SEARCH in the sidebar. Requires [transcript indexing](/docs/search/) to be on.
...
- [Search & privacy](/docs/search/): what indexing stores, the two ways to enable it, and what never leaves your machine.
