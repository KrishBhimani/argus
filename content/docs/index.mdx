...
3. `foreground watcher` when this `argus start` is doing the ingestion, or `argusd daemon` when the [background daemon](/argus/docs/daemon/) owns it.
...
- [CLI reference](/argus/docs/cli/): every command and flag.
- [Search & privacy](/argus/docs/search/): turn on full-text search over transcripts, and what stays on your machine.
- [The dashboard](/argus/docs/dashboard/): what every number and colour means.
