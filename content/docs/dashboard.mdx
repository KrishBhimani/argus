...
| Group | Pages |
| --- | --- |
| MONITOR | [Overview](/docs/overview/) `/`, [Alerts](/docs/alerts/) `/alerts` |
| ANALYZE | [Sessions](/docs/sessions/) `/sessions`, [Tools](/docs/tools/) `/tools`, [Models](/docs/models/) `/models`, [Trends](/docs/trends/) `/trends` |
| SEARCH | [Transcripts](/docs/transcripts/) `/search` |
| GOVERN | [Settings](/docs/settings/) `/settings` |
...
The footer has three monospace lines: `ingesting 412/1183` or `tracking 180 sessions`; `pricing 2026-06-12`, the price table in use; and `foreground watcher` or `argusd daemon`, which tells you whether this process or the [background daemon](/docs/daemon/) is doing the ingestion.
